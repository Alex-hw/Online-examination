		...
		<form action="<%=basePath%>user/update" method="post">
			<div class="bottom">
				<div class="left1">
					...
					<input type="hidden" name="account" id="" value="<%=u.getAccount() %>" class="mima"/>
						...
						<div class="line">
							<span class="word"><span class="xingxing">*</span>用户类型</span>
							<div class="blank">
								<input type="text" name="scale"  value="<%=u.getScale() %>" class="mima"/>
							</div>
						</div>
						<p>登录级别（1/2/3）1:表示超级管理员；2:表示普通管理员（老师）；3：表示考试人员（学生）</p>
						
						<div class="line">
							<span class="word"><span class="xingxing">*</span>手机号码</span>
							<div class="blank">
								<input type="password" name="tel"  value="<%=u.getTel() %>" class="mima"/>
							</div>
						</div>
						<p>输入您的手机号码</p>
