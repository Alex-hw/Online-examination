...
<% String path = request.getContextPath();
	...
	List<QuestStem> qlist=(List<QuestStem>)session.getAttribute("questlist");
	int i=Integer.parseInt(sID);
	QuestStem q=qlist.get(i);
	%>
				...
				<div class="am-g">
					<form class="am-form am-form-horizontal"
						...
						<div class="am-form-group">
							...
							题目Id </label>
							<div class="am-u-sm-9">
								<input type="hidden" id="sID" required placeholder="输入题目ID" 
									name="sID" value="<%=q.getsID() %>"><small>输入题目ID</small>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
							...
							<div class="am-u-sm-9">
								<input type="text" id="questionsName" required placeholder="输入题目名称" 
									name="questionsName" value="<%=q.getQuestionsName() %>"> <small>输入题目名称</small>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
							...
							<div class="am-u-sm-9">
								<input type="text" id="rightKey" required placeholder="输入正确选项" 
									name="rightKey" value="<%=q.getRightKey() %>"> <small>正确选项</small>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
							...
							<div class="am-u-sm-9">
								<input type="text" id="wrongKeyA" required placeholder="错误选项A" 
									name="wrongKeyA"  data-equal-to="#doc-vld-pwd-1"  required value="<%=q.getWrongKeyA() %>"> <small>错误选项A</small>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
							...
							<div class="am-u-sm-9">
								<input type="text" id="wrongKeyB" required placeholder="错误选项B" 
									name="wrongKeyB"  data-equal-to="#doc-vld-pwd-1"  required value="<%=q.getWrongKeyB() %>"> <small>错误选项B</small>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
							...
							<div class="am-u-sm-9">
								<input type="text" id="wrongKeyC" required placeholder="错误选项C" 
									name="wrongKeyC"  data-equal-to="#doc-vld-pwd-1"  required value="<%=q.getWrongKeyC() %>"> <small>错误选项C</small>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
							...
							<div class="am-u-sm-9">
								<input type="text" id="wrongKeyD" required placeholder="错误选项D" 
									name="wrongKeyD"  data-equal-to="#doc-vld-pwd-1"  required value="<%=q.getWrongKeyD() %>"> <small>错误选项D</small>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
							...
							<div class="am-u-sm-9">
								<input type="text" id="score" required placeholder="分值" 
									name="score"  data-equal-to="#doc-vld-pwd-1"  required value="<%=q.getScore() %>"> <small>分值</small>
							</div>
						</div>
						<div class="am-form-group">
							<div class="am-u-sm-9 am-u-sm-push-3">
								<input type="button" class="am-btn am-btn-success" value="修改" onclick="chuan();" />
								<input type="button" class="am-btn am-btn-success" value="返回" onclick="back();" />
...
function chuan(){
$.ajax({
	url : '<%=basePath%>quest/update', //根据操作传入不同的URL
