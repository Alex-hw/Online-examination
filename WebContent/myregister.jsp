...
<div class="header">
		...
		<form action="<%=basePath%>user/updateMyself" method="post">
			<div class="bottom">
				<div class="left1">
					...
					<input type="hidden" name="account" id="account" value="<%=u.getAccount() %>" class="mima"/>
					
						<div class="line">
							<span class="word"><span class="xingxing">*</span>新密码</span>
							<div class="blank">
								<input type="password" name="password"  value="<%=u.getPassword() %>" class="mima"/>
							</div>
						</div>
						<p>6~16个字符，区分大小写</p>
					
					<input type="hidden" name="scale"  value="<%=u.getScale() %>" class="mima"/>
						
						<div class="line">
							<span class="word"><span class="xingxing">*</span>手机号码</span>
							<div class="blank">
								<input type="text" name="tel"  value="<%=u.getTel() %>" class="mima"/>
							</div>
						</div>
						<p>输入您的手机号码</p>
						...
						<div class="line">
							...
							<div class="blank">
								<input type="text" name="unitName"  value="<%=u.getUnitName() %>" class="mima"/>
							</div>
						</div>
						<p>填写您的单位名称</p>
						
						<input class="zhuce" type="submit" value="修改" />
					</div>
				</div>
				<div class="right1">
