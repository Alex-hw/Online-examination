					...
					<div class="am-g">
						<form class="am-form am-form-horizontal" action="role/addroleSubmit.action" method="post" style="padding-top: 30px;">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input id="roleName" required="" placeholder="请输入链接名称" value="" name="roleName" type="text">
									<small id="helpRole">输入链接名称。</small>
								</div>
							</div>
							<div class="am-form-group">
								<label for="user-name" class="am-u-sm-3 am-form-label">
								...
								<div class="am-u-sm-9">
									<textarea rows="" cols="50" placeholder="请输入链接地址" name="roleDesc"></textarea>
									<small>输入链接地址。</small>
								</div>
							</div>
							<div class="am-form-group">
