	    ...
	    <div class="sidebar" data-color="purple" data-image="../assets/img/sidebar-1.jpg">
	    	...
	    	<div class="sidebar-wrapper">
	            <ul class="nav">
	                ...
	                <li>
	                    <a href="<%=basePath%>report.jsp" target="right" >
	                        <i class="material-icons">library_books</i>
	                        <p>成绩管理</p>
	                    </a>
	                </li>
	                <li>
	                    <a href="<%=basePath%>question.jsp" target="right" onclick="">
	                        <i class="material-icons">person</i>
	                        <p>题库管理</p>
	                    </a>
	                </li>
	                <li>
	                    <a href="<%=basePath%>paperlist.jsp" target="right">
	                        <i class="material-icons">location_on</i>
	                        <p>试卷管理</p>
	                    </a>
	                </li>
	                 <!--  <li>
	                    <a href="<%=basePath%>mainframe.jsp" target="right" >
	                        <i class="material-icons">person</i>
	                        <p>考试管理</p>
	                    </a>
	                </li>-->
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row" style="margin-top: -15px;">
						...
						<iframe src="<%=basePath%>question.jsp" width="100%" height="900" name="right" style="border: none;"></iframe>
